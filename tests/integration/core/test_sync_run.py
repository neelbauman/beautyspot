...
def test_project_run_sync_in_context(tmp_path):
    ...
    project = Spot(name="test_run", db=SQLiteTaskDB(tmp_path / "test_run.db"))
...
def test_project_run_async_in_context(tmp_path):
    ...
    project = Spot(name="test_run_async", db=SQLiteTaskDB(tmp_path / "test_run_async.db"))
...
def test_project_run_with_options(tmp_path, inspect_db):
    ...
    with Spot(name="test_opts", db=SQLiteTaskDB(tmp_path / "test_opts.db")) as project:
